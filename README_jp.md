...
***************************************************************************
# 【自己紹介】
台湾出身で、一人前のソフトウェアエンジニアを目指しています。  
2023年6月に「Unityエンジニア養成クラス（Unity工程師養成班）」プログラムに参加し、ソフトウェア開発分野に踏み出す最初の一歩となりました。  
本プログラムでは、複数の学習および実践プロジェクトに取り組み、最終的には[成果発表報告書](https://www.canva.com/design/DAGP0_elCCw/sYSSpWlt3yTxV4hA1F5VnQ/edit?utm_content=DAGP0_elCCw&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton)を作成しました。お目に留まりましたら、ぜひご覧ください。  

現在もC#、Python、Javaを中心に学習を続けており、データベースやフロントエンド技術にも取り組んでいます。  

また、2025年3月よりIT業界にて初級ソフトウェアエンジニアとして勤務しており、銀行系システムの開発および保守業務に携わっています。  
Java、COBOL、Oracle SQLを用いた機能開発・改修対応に加え、障害調査や問い合わせ対応などの実務を通じて技術力の向上に努めています。  

加えて、実務と並行して日本のIT系資格取得にも取り組んでおり、ITパスポート、情報セキュリティマネジメント試験、基本情報技術者試験を2026年3月に取得しました。  
現在はOracle Master Silver SQL（1Z0-071）の取得に向けて学習を継続しています。  

現在は実務経験を積みながら、日本でエンジニアとして働くことを目標に、ポートフォリオ制作や技術習得に継続して取り組んでいます。  
今後も成長を続け、学んだ知識を実践的な形でアウトプットしていきたいと考えています。  

これまでのポートフォリオは[こちら](#ポートフォリオ)からご覧ください。
...
6. **JavaScript** (2025/02~)  
   - **習熟度**: 入門レベル  
   - **学習メモ**: [JavaScriptManual](JavaScriptManual/)  

7. **COBOL** (2025/10~)
   - **習熟度**: 実践レベル  
   - **学習メモ**: [CobolManual](CobolManual/)  
...
## 【今後の課題】
* Python 3マニュアルを作成
* JavaScriptのコーディング技術を磨く
* Oracle Master Silver SQL 2019
  * 2026/04/13、外部サイト(Googleスプシ)：［Oracle Master Silver SQL 2019対策］（https://docs.google.com/spreadsheets/d/1rF515WZzdrP1-TDOLAm6bvIY65A7tzLZRy3JK4BDE3Q/edit?gid=1975707988#gid=1975707988）
...
## 【基本情報技術者試験】
* 2026/03/13、ITパスポート試験、基本情報技術者試験情報、セキュリティマネジメント試験。対策用にHTMLで対策アプリを試作してみた 
